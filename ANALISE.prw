...
@ 220,410 SAY "Versão: 30/11/2011"                                                    SIZE 200,10 PIXEL OF oFolder:aDialogs[1] FONT oBold  COLOR CLR_HBLUE
...
aadd(aHeader, {"Origem"           , "ORIGEM"  , "@!"              , 03       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Data"             , "DATA"    , "99/99/99"        , 08       , 0         ,"U_ValidAC()"       , ""      , "D"    , ""        ,,})
aadd(aHeader, {"Docto."           , "DOCTO"   , "@!"              , 06       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Serie"            , "SERIE"   , "@!"              , 03       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Clie.For"         , "CLIEFOR" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Loja"             , "LOJA"    , "@!"              , 02       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"TES"              , "TES"     , "@!"              , 03       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"CF"               , "CF"      , "@!"              , 03       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Lote"             , "LOTE"    , "@!"              , 10       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Num.Lote"         , "NUMLOTE" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Endereço"         , "ENDERECO", "@!"              , 15       , 0         ,"U_ValidAC()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Qtde."            , "QTDE"    , cPict             , 18       , 2         ,"U_ValidAC()"       , ""      , "N"    , ""        ,,})
aadd(aHeader, {"Qtde.UM2"         , "QTDE2UM" , cPict2UM          , 18       , 2         ,"U_ValidAC()"       , ""      , "N"    , ""        ,,})
