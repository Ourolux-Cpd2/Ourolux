...
ฑฑบPrograma  ณExcelIO() บ Autor ณ Andre Bagatini     บ Data ณ  15/06/11   บฑฑ
...
User Function ExcelIO(aDados)
	...
	DlgToExcel({ {"ARRAY", "Emissใo do Acompanhamento de Vendas", aCabec, aDados} }) // utiliza a fun็ใo
