...
Static Function ReportDef()
    ...
    TRCell():New(oSection ,"DTPORTO"   	,,"Dt. Atracaùùo"       ,		  ,11,,,"CENTER",,"CENTER")
    ...
    TRCell():New(oSection ,"SINPSIR" 	,,"Sinal x PSI R (PRODUùùO)"    ,"@E 9999",04,,,"CENTER",,"CENTER")
    ...
    TRCell():New(oSection ,"MAR"   	   	,,"Embarque x Atracaùùo(Mar)"   ,"@E 9999",04,,,"CENTER",,"CENTER")
    TRCell():New(oSection ,"DESEMB"    	,,"Atracaùùo x NF(Porto)"       ,"@E 9999",04,,,"CENTER",,"CENTER")

    //Grupo Resultado Final (Dias)
    TRCell():New(oSection ,"1COMPRA" 	,,"1ù Compra"   	        ,"@E 9999",04,,,"CENTER",,"CENTER")
