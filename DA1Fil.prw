...
±±ºPrograma  ³DA1FIL    ºAutor  ³ELETROMEGA          º Data ³  01/31/06   º±±
...
User Function TabPro2()
	...
	If Empty( _cFiltro )
        ...
        IF (SA3->A3_TIPO $ 'I' )    // VENDEDOR INTERNO
        	_aSql := "DA1_CODTAB=='1  '"   // TABELA 1  = REVENDA
        
   		ELSE   						       // VENDEDOR EXTERNO
   			
   			IF SA3->A3_COD = "500002"  // CLIENTE/VENDEDOR NOVA SIRIUS
   				_aSql := "DA1_CODTAB=='3  '"   // TABELA 3  = DIRETO
   			ELSE
   				_aSql := "DA1_CODTAB=='6  '"   // TABELA 6  = SUPERMERCADO
   			END
	...
	//AXCadastro( 'DA1', 'Tabela de Preço' )
