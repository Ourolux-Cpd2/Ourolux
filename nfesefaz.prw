...
Static Function NfeTpNota(aNota,aNfVinc,cVerAmb,aNfVincRur,aRefECF,cCFOP)
	...
	Do Case
		...
		*/
		Case (aNota[5]) $ "D" .and. Empty(aNfVinc).and. Alltrim(SFT->FT_CFOP) $ "1201-1202-1410-1411-2411-5921-6921" //Alterado por Bia Ferreira - 14/01/2020
		cTPNota:= "4" 
