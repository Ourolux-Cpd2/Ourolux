...
Static Function WFMAIL(_aprovado, _filial, _pedido, _aprovador,_email,_nomeCom)   
	...
	if alltrim(_aprovado) == 'APROVADO' 
		cMensagem += ' <p align="left">Solicita玢o: '+ _pedido +' Liberada!</p> '
	elseif alltrim(_aprovado) == 'REJEITADO' 
		cMensagem += ' <p align="left">Solicita玢o: '+ _pedido +' Rejeitada!</p> '
    else
        cMensagem += ' <p align="left">Solicita玢o: '+ _pedido +' Bloqueada!</p> '
	endif
