...
Static Function MontaRod()	
	...
	oProforma:Say(2265,035,"DELIVERY TIME (Approval of Pre Shipment Inspection (PSI))",oFont09n)
	...
	oProforma:Say(2431,360, "(FREIGHT, REWORK) AND OTHERS WILL BE CHARGED AS WELL. IF FIRST PRE SHIPMENT INSPECTION (PSI) IS NOT APPROVED, THE FACTORY/SUPPLIER SHOULD PAY A FINE OF 3% OF TOTAL FOB ",oFont08n)
	oProforma:Say(2451,360, "AND FUTURE INSPECTIONS WILL BE SUPPORTED BY SUPPPLIER. (USD300.00 / MAN DAY) FROM THE FACTORY / EXPORTER ON THE PURCHASE ORDER PAYMENT",oFont08n)
	...
	oProforma:Say(2591,360, "3- PRE-SHIPMENT INSPECTION (PSI) WHEN 100% OF PURCHASE ORDER IS READY. (MANDATORY FOR ALL ORDERS" ,oFont08n)
