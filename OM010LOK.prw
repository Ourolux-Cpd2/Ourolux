...
ฑฑบPrograma  ณOM010LOK  บAutor  ณMicrosiga           บ Data ณ  07/14/06   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ  Ponto de entrada para validadar itens das lista de pre็os บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
//ณNao deixa o usuario repetir os codigos de produtos na tabela ณ
//ณde pre็o                                                     ณ
...
If (ALTERA .AND. MV_PAR01 == 2)
	...
	ApMsgStop( 'Opera็ao nao permitida.', 'ATENวรO' )
	lRet := .F.
		...
		For nI := 1 to Len( aCols )		
			If !aCols[nI][Len(aHeader)+1] .AND. n <> nI
				If aCols[n][nPosCodPro] == aCols[nI][nPosCodPro]
					ApMsgStop( 'Produto jแ cadastrado.', 'ATENวรO' )
					lRet := .F.
					Exit
				EndIf
			EndIf                  
